...
#today is the day after new year 2024
...
while game_over == False:
    ...
    if paused == False:
        ...
        if ball.rect.x <= 0:
            p2_win_text = default_font.render('P2 won this round', True, (0,0,0))                               
        ...
        if ball.rect.x >= width:
            p1_win_text = default_font.render('P1 won this round', True, (0,0,0))                               
